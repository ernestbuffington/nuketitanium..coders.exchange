...
//			return ( $transaction == END_TRANSACTION ) ? true : false;
	...
	*/	
	...
	{
	  if($this->db_connect_id):
	  $result  = '<div class="poweredby"> <a class="poweredby" href="http://www.phpnuke.coders.exchange/" target="_blank">Website Powered by PHP-Nuke v'.NUKE_VERSION.' '.NUKE_EDITION.' | &copy; 2000, 2023 Francisco Burzi and The PHP-Nuke Group</a></div>';
