...
-=[Base]=-
      ...
      Debugger                                 v1.0.1       04/18/2023
      Auto Optimize                            v1.0.1       04/18/2023
      Module Simplifications                   v1.0.1       04/18/2023
-=[Other]=-
      DB Connector                             v1.0.1       04/18/2023
      Queries Count                            v2.0.2       04/18/2023
-=[Mod]=-
      Admin Icon/Link Pos                      v1.0.1       04/18/2023
	  NSN Center Blocks                        v2.2.2       04/18/2023
 ************************************************************************/
...
if(($name) && $name === 'Forums'):
$footmsg .= '<a class="poweredby" href="http://www.nuketitanium.coders.exchange/" target="_blank">Forums Powered by phpBB Titanium v'.PHPBB_TITANIUM.'</a>|<a class="poweredby" href="https://www.phpbb.com/about/" target="_blank">&copy; 2000, 2023 The Titanium Group</a><br />';
endif;
...
# START Queries Count v2.0.2
if($queries_count):
$total_time .= ' | DB Queries: <strong><span style="color:'.$digits_color.'">' . $db->num_queries;
$total_time .= '</span></strong>';
endif;
# END Queries Count v2.0.2

# Auto Optimize v1.0.1 START
if(is_admin()): 
 $first_time = false;
...
# Module Simplifications v1.0.1 START 
update_modules();
# Module Simplifications v1.0.1 END 

endif;
# Auto Optimize v1.0.1 END
	
    $footmsg .= $total_time."<br />\n</span>\n";

    # START Debugger v1.0.1
...
# START Admin Icon/Link Pos v1.0.1
...
# END Admin Icon/Link Pos v1.0.1

# START NSN Center Blocks v2.2.2
...
/*****[BEGIN]******************************************
 [ Other:   DB Connectors                      v2.0.1 ]
 [ Other:   Persistent DB Connection           v2.0.1 ]
 ******************************************************/
global $db2, $db;
if(is_object($db))
