...
echo '<tr><td style="height: 23px !important; width: 33.3%;"><div class="above_marquee_one" align="center">PHP-Nuke v'.NUKE_VERSION.' '.NUKE_EDITION.' / PHP v'.PHPVERS.'</div></td>'.PHP_EOL;
echo '<td style="height: 23px !important; width: 33.3%;"><div align="center"></div></td>'.PHP_EOL;
echo '<td style="height: 23px !important; width: 33.3%;"><div class="above_marquee_two" align="center">Sponsor Tron for PHP-Nuke (Titanium Edition)</div></td></tr>'.PHP_EOL;
