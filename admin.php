...
-=[Base]=-
      ...
      Caching System                           v1.0.1       04/10/2023
      Module Simplifications                   v1.0.1       04/10/2023
      Evolution Functions                      v1.5.1       04/10/2023
-=[Other]=-
      Admin Field Size                         v1.0.1       04/10/2023
      Need To Delete                           v1.0.1       04/10/2023
      Date Fix                                 v1.0.1       04/10/2023
-=[Mod]=-
      Admin Icon/Link Pos                      v1.0.1       04/10/2023
      Admin Tracker                            v1.0.2       04/10/2023
      Advanced Username Color                  v1.0.7       04/10/2023
      CNBYA Modifications                      v1.0.1       04/10/2023
      Password Strength Meter                  v1.0.1       04/10/2023
      Auto Admin Protector                     v2.0.1       04/10/2023
      Admin IP Lock                            v2.1.1       04/10/2023
      Evolution Version Checker                v1.1.1       04/10/2023
      Auto Admin Login                         v2.0.2       04/10/2023
      Auto First User Login                    v1.0.1       04/10/2023
      Persistent Admin Login                   v2.0.1       04/10/2023
      External Admin Index                     v1.0.1       04/10/2023
      External Admin Functions                 v1.0.1       04/10/2023
 ************************************************************************/
...
if ((isset($aid)) && (isset($pwd)) && (isset($op)) && ($op == "login")){
    ...
    # Mod: Advanced Security Code Control v1.0.1
    ...
    if (!empty($aid) AND !empty($pwd)){
        ...
        if($rpwd == $pwd && !empty($rpwd)){
	        ...
	        # Mod: Persistent Admin Login v2.0.1
...
if ($admintest){
	...
	switch($op){
        ...
        break;
        case "adminMain":
            # Mod: External Admin Index v1.0.1
        ...
        default:
            ...
            # Mod: Admin Icon/Link Pos v1.0.1
