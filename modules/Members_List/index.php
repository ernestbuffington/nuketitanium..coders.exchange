...
/*****[CHANGES]**********************************************************
-=[Base]=-
      PHP Patched                              v8.2.4       04/19/2023
-=[Mod]=-
      Advanced Username Color                  v1.0.6       04/19/2023
      Memberlist Find User                     v1.0.1       04/19/2023
      Online/Offline/Hidden (Selection Order)  v1.0.1       04/19/2023
      Online/Offline/Hidden                    v2.2.8       04/19/2023
	  Member Country Flags                     v2.0.8       04/19/2023
	  Birthdays                                v3.0.1       04/19/2023
 ************************************************************************/
...
$template->assign_vars([
    ...
    # Mod: Selection Order v1.0.1 START
    # Mod: Birthdays v3.0.1 START
    'S_MODE_SELECT' => select_box('mode',$mode,['joined' => 
						   ...
						   $lang['Sort_Username'], 'location' => 
							  ...
							  $lang['Sort_Top_Ten'], 'online' => 
							           $lang['Current_status']]),
    # Mod: Selection Order v1.0.1 END
    # Mod: Birthdays v3.0.1 END
...
if($row = $db->sql_fetchrow($result)):
	...
	do
	{
        ...
        /*****[BEGIN]*****************************************
        [ Mod:    Forum Index Avatar Mod              v1.0.1 ]
        ******************************************************/
	   ...
	   # Mod: Online/Offline/Hidden v2.2.8 START
       ...
       # Mod: Online/Offline/Hidden v2.2.8 END
...
if(!isset($_POST['alphanum'])) { $_POST['alphanum'] = ''; }
if(!isset($_GET['alphanum'])) { $_GET['alphanum'] = ''; }
# Generate the page numbers
$alphanum 	= ($_POST['alphanum']) ? htmlspecialchars((string) $_POST['alphanum']) : htmlspecialchars((string) $_GET['alphanum']);
$where 		= ( $alphanum == 'num' ) ? " AND `username` NOT RLIKE '^[A-Z]' " : " AND `username` LIKE '".$alphanum."%' ";
