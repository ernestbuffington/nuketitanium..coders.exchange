  ...
  if ( ($total_forums = count($forum_data)) === 0 )
  {
    ...
    if (isset($userdata['session_logged_in']))
    {
        ...
        ******************************************************/
        ...
        if(!isset($images['up_arrow'])) { $images['up_arrow'] = ''; }
        if(!isset($images['down_arrow'])) { $images['down_arrow'] = ''; }
        if(!isset($images['icon_sign_plus'])) { $images['icon_sign_plus'] = ''; }
        if(!isset($images['icon_sign_minus'])) { $images['icon_sign_minus'] = ''; }
        if(!isset($images['Mini_Arcade'])) { $images['Mini_Arcade'] = ''; }
