<?php
/************************************************************************/
/* PHP-NUKE: Web Portal System (Titaium Edition)                        */
/* ===========================                                          */
/*                                                                      */
...
-=[Mod]=-
      Forum Logout                             v1.0.1       04/10/2023
      YA Merge                                 v1.0.1       04/10/2023
      User IP Lock                             v1.0.1       04/10/2023
 *********************************************************************************/
...
switch($op): 
    ...
    break;
    case "edituser":
		# Mod: YA Merge v1.0.1 START
        redirect("modules.php?name=Profile&mode=editprofile");
        exit;
        # Mod: YA Merge v1.0.1 END
    break;
    case "login":
        # Base: NukeSentinel v2.5.16 START
        global $nsnst_const, $user_prefix;
        # Base: NukeSentinel v2.5.16 END
   ...
   if ($db->sql_numrows($result) == 0): 
		  ...
		  # Base: Evolution Functions v1.5.1 START
		 ...
		 # Mod: Advanced Security Code Control v1.0.1 START
         $gfxchk = array(2,4,5,7);

         if (!security_code_check($_POST['g-recaptcha-response'], $gfxchk)):
            redirect("modules.php?name=$module_name&stop=1");
            exit;
         # Mod: Advanced Security Code Control v1.0.1 END
