...
define_once("_NEWS_ADMIN_HEADER", "Nuke-Evolution News :: Modules Admin Panel");
define_once("_NEWSSUBMISSION_ADMIN_HEADER", "Nuke-Evolution Submissions :: Modules Admin Panel");
define_once("_NEWSCONFIG_ADMIN_HEADER", "Nuke-Evolution News Configuration :: Modules Admin Panel");
define_once("_NEWS_RETURNMAIN", "Return to Main Administration");
...
/*****************************************************/
define_once("_NE_ARTPUB","Article Published");
define_once("_NE_HASPUB","The article you submitted has been published. You can view it at:");
...
define_once("_NE_HOMENUMNOTE","This will over-ride user preferences<br />\nif set other then Nuke Default");
define_once("_NE_SAVECHANGES","Save Changes");

/*****[BEGIN]******************************************
 [ Mod:    Display Topic Icon                  v1.0.0 ]
 ******************************************************/
define_once("_DISPLAY_T_ICON","Display Topic Icon with News Article?");
/*****[END]********************************************
 [ Mod:    Display Topic Icon                  v1.0.0 ]
 ******************************************************/
/*****[BEGIN]******************************************
 ...
 ******************************************************/
define_once("_DISPLAY_WRITES","Display Author Writes \"text\" with News Article?");
/*****[END]********************************************
 [ Mod:    Display Writes                      v1.0.0 ]
 ******************************************************/
